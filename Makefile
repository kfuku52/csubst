...
TYPECHECK_TARGETS += csubst/endpoint.py csubst/endpoint_io.py csubst/scan_analytic.py csubst/scan_ctmc.py csubst/scan_endpoint.py csubst/fitted_model.py csubst/event_reporting.py
TYPECHECK_TARGETS += csubst/output_safety.py csubst/output_run.py
